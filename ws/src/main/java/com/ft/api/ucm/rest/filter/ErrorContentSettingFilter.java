...
/**
 * A Servlet Filter sets the desired content for statusCode >= 400
 *
 * @author alberto.faci
 */
public class ErrorContentSettingFilter extends OncePerRequestFilter {
  ...
  protected final void doFilterInternal(
    ...
    ContentResponseWrapper wrapper =
        new ContentResponseWrapper(request, response, mediaTypesMap, defaultContentType);
  ...
  static class ContentResponseWrapper extends HttpServletResponseWrapper {
    ...
    public ContentResponseWrapper(
        ...
        Map<String, String> mediaTypesMap,
