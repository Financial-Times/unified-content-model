...
public class UserContextLoggingFilter /*extends Log4jNestedDiagnosticContextFilter*/ {
  ...
  //    public static final String CONTENT_CONTROL_POLICY_HEADER =
  // "X-FT-API-Content-Control-Policy";
  ...
  //			appendTo.append(API_KEY_LABEL)
  //                    .append('=')
  //                    .append(apikey)
  //                    .append(' ');
  //        }
  //
  //		appendTo.append(USER_IP_LABEL)
  //                .append('=')
  //                .append(StringUtils.isBlank(ip) ? request.getRemoteAddr() : ip)
  //                .append(' ');
  //
  //        appendTo.append(CONTENT_CONTROL_POLCIY_LABEL)
  //                .append('=')
  //                .append(contentControlPolicy == null ? "" : contentControlPolicy)
  //                .append(' ');
  //
  //        appendTo.append(REQUEST_ID_LABEL)
  //                .append('=')
