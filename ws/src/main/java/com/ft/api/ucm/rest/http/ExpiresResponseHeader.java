...
/**
 * A {@link ResponseHeader} that adds an 'Expires' response header which must be in RFC1123 format
 * as specified in http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.21
 *
 * @author Dan
 */
