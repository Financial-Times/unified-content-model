...
/**
 * A Servlet Filter configured with a list of {@link ResponseHeader} objects which are applied to
 * any {@link HttpServletResponse} mapped to this Filter.
 *
...
public class ResponseHeaderSettingFilter extends OncePerRequestFilter {
  ...
  protected final void doFilterInternal(
    ...
    ResponseHeaderLoggingResponseWrapper wrapped =
        new ResponseHeaderLoggingResponseWrapper(response);
