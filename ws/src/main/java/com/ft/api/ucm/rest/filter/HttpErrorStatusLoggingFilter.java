...
public class HttpErrorStatusLoggingFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    HttpErrorStatusLoggingResponseWrapper wrapper =
        new HttpErrorStatusLoggingResponseWrapper(response, request, supportLogger);
  ...
  static class HttpErrorStatusLoggingResponseWrapper extends HttpServletResponseWrapper {
    ...
    HttpErrorStatusLoggingResponseWrapper(
        HttpServletResponse response, HttpServletRequest request, SupportLogger supportLogger) {
      super(response);
